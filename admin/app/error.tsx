...
export default function Error({
  ...
  // This component will be detected by AdminLayout and will not show the navbar
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4">
      <div className="w-full max-w-md mx-auto text-center">
        {/* Logo */}
        <Link href="/" className="inline-block mb-8" aria-label="October Security - Home">
          <Image
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mb-8 p-4 bg-gray-100 dark:bg-gray-800 rounded-md text-left overflow-auto max-h-40">
        ...
        <p className="mt-8 text-sm text-gray-500 dark:text-gray-400">
          Need help? <Link href="/contact" className="text-blue-600 hover:underline dark:text-blue-400">Contact support</Link>
        </p>
      </div>
